<?php
/**
 * WPCT Taxonomy : WP_Taxonomy class
 *
 * @package Custom Taxonomy
 * @subpackage 
 * @since 1.0
 * @desc This class is a copy of @WP_Taxonomy from core. 
 * It is important to have this class as duplicated for compatibility issues.
 */
...
class WPCT_Taxonomy {
    ...
    public static function newInstance( $custom_taxonomy_data, $taxonomy_labels, $object_type) {
        $taxonomy_data_with_labels = array_merge( $custom_taxonomy_data, array('labels' => $taxonomy_labels));
        $instance = new WPCT_Taxonomy($custom_taxonomy_data['name'], $object_type, $taxonomy_data_with_labels);
        return $instance;
    }
    public static function newInstanceFromJSOM($taxonomyJsonData) {
        $custom_taxonomy_data = json_decode($taxonomyJsonData);
        $custom_taxonomy_data->name;
        $instance = new WPCT_Taxonomy($custom_taxonomy_data->name, $custom_taxonomy_data->object_type, $custom_taxonomy_data);
        return $instance;
    }
