...
class WPG_Settings {
	...
	public static function get_settings() {
		$option_sections = array(
			'section_index'									=> array(
				'heading'									=> __( 'Glossary Index Page', WPG_TEXT_DOMAIN ),
				'options'									=> array(
					...
					'wpg_glossary_archive'					=> array(
						...
						'label'								=> __( 'Glossary Archive', WPG_TEXT_DOMAIN ),
						'type'								=> 'checkbox',
						'default'							=> 'yes',
					...
					'wpg_glossary_page_id'					=> array(
						...
						'label'								=> __( 'Glossary Page/Post ID', WPG_TEXT_DOMAIN ),
						'type'								=> 'text',
					...
					'wpg_glossary_layout'					=> array(
						...
						'label'								=> __( 'Glossary Page Layout', WPG_TEXT_DOMAIN ),
						'type'								=> 'select',
					...
					'wpg_glossary_thumbnail_permited'		=> array(
						'name'								=> 'wpg_glossary_thumbnail_permited',
						'label'								=> __( 'PERMIT Custom thumbnails', WPG_TEXT_DOMAIN ),
						'type'								=> 'checkbox',
						'default'							=> 'yes',
						'desc'								=> __( 'Select this option if you want to permit the use of custom thumbnails in the Term Post Page and on the lists.', WPG_TEXT_DOMAIN )
					),
					'wpg_glossary_thumbnail'				=> array(
						'name'								=> 'wpg_glossary_thumbnail',
						'label'								=> __( 'Use thumbnails by default', WPG_TEXT_DOMAIN ),
						'type'								=> 'checkbox',
						'default'							=> 'yes',
						'desc'								=> __( 'Select this option if you want to use thumbnails as default for items on the lists.', WPG_TEXT_DOMAIN )
					),
				)
			),
			
			'section_linkify'								=> array(
				'heading'									=> __( 'Glossary Linkify', WPG_TEXT_DOMAIN ),
				'options'									=> array(
			...
			'section_tooltip'								=> array(
				'heading'									=> __( 'Glossary Tooltip', WPG_TEXT_DOMAIN ),
				'options'									=> array(
			...
			'section_custom_css'							=> array(
				'heading'									=> __( 'Glossary Custom Styles', WPG_TEXT_DOMAIN ),
				'options'									=> array(
